  ...
  const stream = new ReadableStream({
    async start(controller) {
      const messages = [
        ...
        'data: {"type":"start-step"}',
        'data: {"type":"text-start","id":"0"}',
        'data: {"type":"tool-input-start","toolCallId":"call_88pop2z138ayb3vzk0jicgd41","toolName":"write_todos"}',
        'data: {"type":"tool-input-delta","toolCallId":"call_88pop2z138ayb3vzk0jicgd41","inputTextDelta":"Updated todo list to [{\\"content\\":\\"读取/home/tiger/u86l8o/docs/art.md文档内容\\",\\"status\\":\\"completed\\"},{\\"content\\":\\"解析文档中的素材需求，生成资产索引JSON结构\\",\\"status\\":\\"completed\\"},{\\"content\\":\\"遍历资产索引，为每个素材调用generate_image_1k生成复古风格图片\\",\\"status\\":\\"in_progress\\"},{\\"content\\":\\"更新资产索引中的image_url字段为实际生成的图片路径\\",\\"status\\":\\"pending\\"},{\\"content\\":\\"生成交付报告，列出所有成功/失败的素材\\",\\"status\\":\\"pending\\"}]"}',
        'data: {"toolName":"write_todos","input":"Updated todo list to [{\\"content\\":\\"读取/home/tiger/u86l8o/docs/art.md文档内容\\",\\"status\\":\\"completed\\"},{\\"content\\":\\"解析文档中的素材需求，生成资产索引JSON结构\\",\\"status\\":\\"completed\\"},{\\"content\\":\\"遍历资产索引，为每个素材调用generate_image_1k生成复古风格图片\\",\\"status\\":\\"completed\\"},{\\"content\\":\\"更新资产索引中的image_url字段为实际生成的图片路径\\",\\"status\\":\\"pending\\"},{\\"content\\":\\"生成交付报告，列出所有成功/失败的素材\\",\\"status\\":\\"pending\\"}]","type":"tool-input-available","toolCallId":"call_88pop2z138ayb3vzk0jicgd41"}',
        'data: {"output":"Updated todo list to [{\\"content\\":\\"读取/home/tiger/u86l8o/docs/art.md文档内容\\",\\"status\\":\\"completed\\"},{\\"content\\":\\"解析文档中的素材需求，生成资产索引JSON结构\\",\\"status\\":\\"completed\\"},{\\"content\\":\\"遍历资产索引，为每个素材调用generate_image_1k生成复古风格图片\\",\\"status\\":\\"completed\\"},{\\"content\\":\\"更新资产索引中的image_url字段为实际生成的图片路径\\",\\"status\\":\\"pending\\"},{\\"content\\":\\"生成交付报告，列出所有成功/失败的素材\\",\\"status\\":\\"pending\\"}]","type":"tool-output-available","toolCallId":"call_88pop2z138ayb3vzk0jicgd41"}',
        'data: {"type":"text-end","id":"0"}',
